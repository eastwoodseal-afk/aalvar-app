...
function HomePageContent() {
  ...
  // Estado para el shot seleccionado en el panel derecho
  const [selectedShot, setSelectedShot] = useState<any>(null);

  // Usuario logueado O usuario no logueado sin split: vista normal con muro completo (layout ya renderiza Header)
  if (selectedShot) {
    // Mostrar muro con panel derecho de detalle
    return (
      <>
        <div className="flex flex-col md:flex-row" style={{ height: 'calc(100vh - 64px)' }}>
          ...
          {/* Panel derecho: Detalle del shot */}
